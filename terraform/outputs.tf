...
output "cluster_endpoint" {
  ...
  value       = module.chat_app_eks.cluster_endpoint
}

output "cluster_version" {
  description = "The Kubernetes version for the EKS cluster"
  value       = module.chat_app_eks.cluster_version
}

output "cluster_security_group_id" {
  description = "Security group ID attached to the EKS cluster"
  value       = module.chat_app_eks.cluster_security_group_id
}

output "cluster_oidc_issuer_url" {
  description = "The URL on the EKS cluster for the OpenID Connect identity provider"
  value       = module.chat_app_eks.cluster_oidc_issuer_url
}
...
output "configure_kubectl" {
  ...
  value       = "aws eks update-kubeconfig --region ${var.aws_region} --name ${module.chat_app_eks.cluster_name}"
}
...
output "chat_app_url" {
  description = "Command to get the chat application URL"
...
output "useful_commands" {
  ...
  value = {
    ...
    get_chat_app        = "kubectl get pods -n chat-app"
