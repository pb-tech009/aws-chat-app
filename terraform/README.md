# This is an eks and we also make this all on the kind cluster and this also work fabulous and smart to get this so this all are work fine and ok and also this was the EKS so you can also make this all 

<!-- check in the vc code  -->
# aws eks update-kubeconfig --region ap-south-1 --name chatapp-eks
then you can see this 

Now check where kubectl is pointing:

kubectl config current-context

If you see something like:

arn:aws:eks:ap-south-1:123456789012:cluster/chatapp-eks

🎉 Good — you are talking to your EKS cluster, not your local kind one.

If it still shows kind-kind, then run:
